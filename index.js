...
const CUSTOM_OBJECT_ID = "2-140710940";
...
app.get("/", async (req, res) => {
  ...
  try {
    const resp = await axios.get(franchises, { headers });
    const data = resp.data.results;
    res.render("homepage", { title: "Franchises | HubSpot APIs", data });
  } catch (error) {
    console.error(error);
  }
});
...
app.get("/update-cobj", (req, res) => {
  res.render("updates", { title: "Update Franchise Form | HubSpot" });
});
